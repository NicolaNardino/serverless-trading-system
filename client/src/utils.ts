...
function buildRandomOrders(nrOrders: number): EntryOrder[] {
    ...
    const tickers = ['PM', 'BTI', 'FB', 'AMD', 'AMZN', 'AAPL', 'GOOG', 'NFLX', 'F', 'T', 'MO', 'PFE', 'COIN', 'MRNA', 'ORCL', 'TSLA', 'SOPH', 'NVDA', 'MSFT', 'UBSG.SW', 'CSGN.SW', 'HOLN.SW', 'CHSPI.SW', 'EOG', 'PBR', 'PBR-A', 'RBLX', 'CDEV', 'BABA', 'SPY', 'VTI', 'VOO', 'ADBE'];
